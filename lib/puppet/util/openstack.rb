##
# This code has been copied from puppet-keystone assuming that this will be part
# of openstacklib sooner. Original code can be found at
# https://github.com/stackforge/puppet-keystone/blob/master/lib/puppet/util/openstack.rb
##
